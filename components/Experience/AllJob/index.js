const Data = [
  {
    Title: "PT.beIT Inovasi Tiwikrama (Front End)",
    tech: "Vue, Nuxt, React, Next, Express,MongoDB,PostgreSQL PHP, Docker, TypeScript",
    Deskripsi:
      "Singapore Power, Switch US, SRN MNLHK, SRN PTBAE (Persetujuan Teknis Batas Atas Emisi), Sampoerna Academy, Florida Power Light (Next Energy), Dimension Data (NTT), BELL (Canada). Bekerja sama dengan SE.COM (Schneider Electric Global).",
  ...
  },
  {
    ...
    Deskripsi:
      "Mengembangkankan Aplikasi Milik PT.JasaMarga Persero (BUMN) Untuk Modul Training, Digital Learning, Content Creator, Exposure & Coacing.  Serta Mengembangkan Aplikasi Milik Simedic.",
  ...
  },
  {
    ...
    Deskripsi:
      "Mengembangkankan Aplikasi ERP. Sub Modul ERP. Penilaiai Performa Dan Target Dari Industri.",
  ...
  },
  {
    ...
    tech: "CCNA, Technicaal Support Hardware Sofware PC",
    Deskripsi:
      "Bekerja Sebagai Operator Tata Usaha Dan Guru Teknologi Informasi Dan Komunikasi (Komputer). Serta Maintance Berbagai Networking Serta Kebutuhan Sekolah.",
                ...
                <div className="pt-10 pb-12 px-6 sm:pt-16 sm:px-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20 ">
                  <div className="lg:self-center">
                    <h2 className="text-3xl font-extrabold text-white sm:text-4xl">
                      ...
                      <span className="block text-xl pt-4">
